...
public class BookService {
    ...
    public Long countAllInStock() {
        TypedQuery<Long> query = em.createQuery("SELECT COUNT(b) FROM Book b WHERE b.numberInStock != 0", Long.class);
        return query.getSingleResult();
    }
    ...
    public List<Book> findInStock() {
        TypedQuery<Book> query = em.createQuery(
                "SELECT b FROM Book b WHERE b.numberInStock > 0", Book.class);
        return query.getResultList();
    }
